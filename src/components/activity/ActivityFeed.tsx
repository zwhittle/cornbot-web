        ...
        <li key={event.id} className='flex justify-between gap-x-6 py-5'>
          <div className='flex gap-x-4'>
            ...
            <div className='min-w-0 flex-auto'>
              <p className='text-sm font-semibold leading-6 text-white'>{event.type}</p>
              <p className='mt-1 truncate text-xs leading-5 text-gray-400'>{event.memberId}</p>
            </div>
          </div>
          <div className='hidden sm:flex sm:flex-col sm:items-end'>
            <p className='text-sm leading-6 text-white'>{event.guildId}</p>
            {event.timestamp && (
